          ...
          <Card>
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">3 assignments due this week</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Math test on Friday</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">15 new resources available</p>
              </div>
            </CardContent>
          </Card>
        </div>

...
const Subjects = () => {
  ...
  const handlePdfClick = (url: string, subjectName: string) => {
    try {
      ...
      console.error(`Error opening PDF for ${subjectName}:`, error);
      alert(`Unable to open PDF for ${subjectName}. Please try again.`);
    }
  };
              ...
              {subjects.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {subjects.map((subj, index) => (
                    <Card
                      key={subj._id} // Use _id as key for better React performance
                    ...
                    >
                      ...
                      <CardContent className="relative p-8 space-y-4">
                        ...
                        <div>
                          ...
                          <button
                            onClick={() => handlePdfClick(subj.syllabusPdfUrl, subj.name)}
                            className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200 text-sm font-medium mt-2"
                          >
                            View Syllabus PDF
                          </button>
                        </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-sm">
                          Your class schedule will appear here once it's
                          available.
                        </p>
                      </div>
                    </div>
